...
namespace Arcane.Axl {
    ...
    public partial class ModuleT4 : ModuleT4Base {
        ...
        public virtual string TransformText() {
            ...
            this.Write("/*---------------------------------------------------------------------------*/\n/" +
                    "*---------------------------------------------------------------------------*/\n/" +
                    "/ #WARNING#: Ce fichier a été généré automatiquement. Ne pas modifier.\n// Axlstar" +
                    " version ");
...
");
  if (Module.HasMultiDimVariable) { 
            this.Write(@"#include ""arcane/core/MeshMDVariableRef.h""
// Ces deux en-têtes ont été ajoutés en juillet 2026
#if __has_include(""arcane/core/MeshMatrixMDVariableRef.h"")
#include ""arcane/core/MeshMatrixMDVariableRef.h""
#endif
#if __has_include(""arcane/core/MeshVectorMDVariableRef.h"")
