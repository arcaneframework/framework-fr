...
_doTestLambda1(RunQueue queue)
{
  ...
  // Test de lancement de lambda direct
  {
  ...
  // Test de lancement de lambda mutable direct
  {
    _fillArray(a, 5);
...
// Vérification en utilisant une boucle avec un NumArray utilisant 'Int64' comme type d'index
void
