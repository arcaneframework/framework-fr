...
/*                                                                           */
/* Analyseur d'options de programme (remplacement de boost::program_options).*/
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Base effacée de type pour la sémantique des valeurs d'options.
 */
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Valeur d'option typée avec prise en charge des valeurs par défaut, requises et multitokens.
 */
template <typename T>
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Spécialisation pour les options de bascule booléenne.
 */
template <>
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Spécialisation pour std::vector<std::string> (multitoken).
 */
template <>
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Option de présence uniquement (pas de valeur, juste un drapeau).
 *
 * Utilisée pour les drapeaux nus comme ("help,h", "description") où
 * l'option n'a pas de sémantique de valeur.
 */
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Crée une valeur d'option typée.
 */
template <typename T>
typed_value<T>*
value()
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Crée une valeur d'option typée liée à une variable.
 */
template <typename T>
typed_value<T>*
value(T* v)
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Crée une option de bascule booléenne.
 */
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Crée une option de bascule booléenne liée à une variable.
 */
inline typed_value<bool>*
bool_switch(bool* v)
{
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Descripteur interne pour une seule option.
 */
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Décrit un ensemble d'options en ligne de commande.
 */
class ARCCORE_COMMON_EXPORT options_description
{
 public:
  ...
  /*!
   * \brief Proxy pour les appels en chaîne add_options()().
   */
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Stocke les valeurs d'options analysées.
 */
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Décrit les arguments positionnels (non-options).
 */
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Résultat de l'analyse des arguments en ligne de commande.
 */
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Constructeur d'analyseur d'arguments en ligne de commande fluide.
 */
