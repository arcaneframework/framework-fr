...
/*                                                                           */
/* Diverses utilitaires pour gérer le passage de messages.                   */
/*---------------------------------------------------------------------------*/
...
/// Wrapper de commodité autour de MPI_Init/MPI_Finalize.
struct mpi_init
{
...
/// Wrapper de commodité autour de MPI_Init_threads/MPI_Finalize.
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Wrapper de commodité autour de MPI_Comm.
 */
struct mpi_communicator
{
  ...
  /*!
   * \brief Vérification de condition par communicateur.
   *
   * Vérifie les conditions à chaque processus du communicateur ;
   *
   * Si la condition est fausse sur l'un des processus participants, il renvoie
   * le message fourni ainsi que les rangs des processus fautifs.
   * Après cela, chaque processus du communicateur lève une exception.
   */
 ...
 private:
  ...
  {
    // Spécialisation pour 'std::complex<float>' en tant que 2 flottants.
