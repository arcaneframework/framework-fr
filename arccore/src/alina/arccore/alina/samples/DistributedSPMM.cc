...
void test()
{
  // Dans le cas d'un bloc, Rhs peut être une StaticMatrix.
  ...
  // Parce que Rhs peut être une StaticMatrix et n'est pas un type de base
  // nous le convertissons en un tableau de type de base (qui est math::scalar_of<Rhs>::type).
