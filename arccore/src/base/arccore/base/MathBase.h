...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Espace de noms pour les fonctions mathématiques.
 *
 * Cet espace de noms contient toutes les fonctions mathématiques utilisées
 * par le code.
 */
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Logarithme naturel de \a v.
 */
...
/*!
 * \brief Arrondit \a v à l'entier immédiatement inférieur.
 */
ARCCORE_HOST_DEVICE inline double
floor(double v)
{
 ...
 *
 * Calcule \a x à la puissance \a y.
 *
 * \pre x>=0 ou y est un entier
 */
ARCCORE_HOST_DEVICE inline double
pow(double x, double y)
{
#ifdef ARCCORE_DO_CHECK_MATH
  // Arguments invalides si x est négatif et y n'est pas un entier
  if (x < 0.0 && ::floor(y) != y)
...
/*!
 * \brief Retourne le minimum de deux nombres réels.
 * \ingroup GroupMathUtils
 */
ARCCORE_HOST_DEVICE inline long double
...
/*!
 * \brief Retourne le maximum de deux nombres réels.
 * \ingroup GroupMathUtils
 */
ARCCORE_HOST_DEVICE inline long double
...
/*!
 * \brief Retourne la valeur absolue d'un nombre réel.
 * \ingroup GroupMathUtils
 */
ARCCORE_HOST_DEVICE inline long double
abs(long double a)
