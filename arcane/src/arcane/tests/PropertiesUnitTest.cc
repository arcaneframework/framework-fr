...
#define DO_TEST(CppDataType, DataType, Value) \
  { \
    info() << "Test de la propriété " #DataType; \
    CppDataType x = Value; \
    CppDataType xget; \
...
#define DO_TEST_ARRAY(DataType, Value) \
  { \
    info() << "Test de la propriété tableau " #DataType; \
    DataType x = Value; \
    DataType x2; \
    p.set(#DataType, x); \
    p.get(#DataType, x2); \
...
#define DO_COMPARE(DataType) \
  { \
    info() << "Comparaison de la propriété " #DataType; \
...
#define DO_COMPARE_ARRAY(DataType) \
  { \
    info() << "Comparaison de la propriété tableau " #DataType; \
    DataType x1; \
    DataType x2; \
    p.get(#DataType, x1); \
    p2.get(#DataType, x2); \
