...
_init()
{
  ...
  my_name.copy(host_name.utf8()); // copie et réduit la taille du tableau à la taille de l'argument
  my_name.resize(max_len, '\0'); // ajoute \0 pour remplir jusqu'à max_len
