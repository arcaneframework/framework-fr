...
TEST(NumArray, Basic)
{
  std::cout << "TEST_NUMARRAY Basique\n";
...
{
  std::cout << "TEST_NUMARRAY Basique2\n";
...
TEST(NumArray3, Move)
{
  // Test NumArray::NumArray(NumArray&&)
  {
    ...
    std::cout << "PART_2\n";
    ASSERT_EQ(test_move.totalNbElement(), wanted_size1) << "Taille incorrecte (test move 1)";
    ASSERT_EQ(test_move[6], wanted_size1 + 8) << "Taille incorrecte (test move 2)";
    Int32 wanted_size2 = 17;
    test_move = _createNumArray(wanted_size2);
    std::cout << "PART_3\n";
    ASSERT_EQ(test_move.totalNbElement(), wanted_size2) << "Taille incorrecte (test move 3)";
    ASSERT_EQ(test_move[3], wanted_size2 + 5) << "Taille incorrecte (test move 4)";
  }
  // Test NumArray::operator=(NumArray&&)
  {
    ...
    std::cout << "PART_5\n";
    ASSERT_EQ(test_move.totalNbElement(), wanted_size1) << "Taille incorrecte (test move 1)";
    ASSERT_EQ(test_move[7], wanted_size1 + 9) << "Taille incorrecte (test move 2)";
  }
}
...
{
  std::cout << "TEST_NUMARRAY2 Disposition\n";
...
{
  std::cout << "TEST_NUMARRAY3 Disposition\n";
