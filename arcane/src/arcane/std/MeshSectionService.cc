...
/*                                                                           */
/* Service permettant la création d'un maillage avec une section d'un        */
/* autre maillage.                                                           */
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
...
/*!
 * \brief Service permettant la création d'un maillage avec une section d'un autre maillage.
 *
 * Vous pouvez définir une section de maillage avec la méthode \a addPlan(). Toutes les mailles
 * (leur barycentre) entre ces plans seront copiées dans un second maillage
 * créé par ce service. Vous pouvez obtenir ce maillage avec la méthode
 * \a meshSection().
 */
