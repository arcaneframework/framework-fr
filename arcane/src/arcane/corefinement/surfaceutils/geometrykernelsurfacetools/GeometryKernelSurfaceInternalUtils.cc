...
//-----------------------------------------------------------------------------
#include "arcane/corefinement/surfaceutils/geometrykernelsurfacetools/GeometryKernelSurfaceInternalUtils.h"
/* Auteur : havep le Mer 1 Avr 14:31:35 2009
 * Généré par createNew
 */
                           ...
                           Real3& normal)
{
  ...
  ENUMERATE_FACE (iface, group) {
    ...
    case IT_Quad4:
      ...
      break;
    default:
      throw NotImplementedException(A_FUNCINFO, "Type de face non Tri3 ou Quad4");
    }
  }
