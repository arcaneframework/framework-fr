...
9. \subpage arcanedoc_core_types_numarray <br>
  Décrit l'utilisation de la classe \arcane{NumArray} et des types associés.

10. \subpage arcanedoc_core_types_array_views <br>
  Décrit l'utilisation des classes \arcane{ArrayView}, \arcane{ConstArrayView}, \arcane{Span}, \arcane{SmallSpan}
